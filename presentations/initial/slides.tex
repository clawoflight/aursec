...
\begin{itemize}
	...
	\item 3 different Requests %TODO: Ich glaube nicht, dass wir die erklären müssen, sie sind nicht so wichtig...
...
\end{itemize}
\note{2min L \\ Orphan,Deletion,Merge}
\end{frame}
...
\includegraphics<2>[width=\textwidth]{threat2.png} %TODO: change to reworked threatdiag.
\note{1 min L}
\end{frame}
